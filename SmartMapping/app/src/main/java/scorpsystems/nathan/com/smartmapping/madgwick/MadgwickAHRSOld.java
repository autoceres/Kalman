package scorpsystems.nathan.com.smartmapping.madgwick;
...
public class MadgwickAHRSOld {
	...
	/**
	 * Initializes a new instance of the {@link MadgwickAHRSOld} class.
	 * 
	 * @param samplePeriod
	 *            Sample period.
	 */
	public MadgwickAHRSOld(double samplePeriod) {
	 ...
	 *            Algorithm gain beta.
	 */
	public MadgwickAHRSOld(double samplePeriod, double beta) {
		this.samplePeriod = samplePeriod;
		this.beta = beta;
		this.quaternion = new double[] { 1d, 0d, 0d, 0d };		
	}
	...
	public void update(double gx, double gy, double gz, double ax, double ay,
		...
		double _2q3 = 2d * q3;
		double _2q4 = 2d * q4;
		double _2q1q3 = 2d * q1 * q3;
		double _2q3q4 = 2d * q3 * q4;
		double q1q1 = q1 * q1;
		double q1q2 = q1 * q2;
		double q1q3 = q1 * q3;
		double q1q4 = q1 * q4;
		...
		s1 = -_2q3 * (2d * q2q4 - _2q1q3 - ax) + _2q2
				* (2d * q1q2 + _2q3q4 - ay) - _2bz * q3
				* (_2bx * (0.5d - q3q3 - q4q4) + _2bz * (q2q4 - q1q3) - mx)
				+ (-_2bx * q4 + _2bz * q2)
				* (_2bx * (q2q3 - q1q4) + _2bz * (q1q2 + q3q4) - my) + _2bx
				* q3
				* (_2bx * (q1q3 + q2q4) + _2bz * (0.5d - q2q2 - q3q3) - mz);
		s2 = _2q4 * (2d * q2q4 - _2q1q3 - ax) + _2q1
				* (2d * q1q2 + _2q3q4 - ay) - 4d * q2
				* (1 - 2d * q2q2 - 2d * q3q3 - az) + _2bz * q4
				* (_2bx * (0.5d - q3q3 - q4q4) + _2bz * (q2q4 - q1q3) - mx)
				+ (_2bx * q3 + _2bz * q1)
				* (_2bx * (q2q3 - q1q4) + _2bz * (q1q2 + q3q4) - my)
				+ (_2bx * q4 - _4bz * q2)
				* (_2bx * (q1q3 + q2q4) + _2bz * (0.5d - q2q2 - q3q3) - mz);
		s3 = -_2q1 * (2d * q2q4 - _2q1q3 - ax) + _2q4
				* (2d * q1q2 + _2q3q4 - ay) - 4d * q3
				* (1 - 2d * q2q2 - 2d * q3q3 - az) + (-_4bx * q3 - _2bz * q1)
				* (_2bx * (0.5d - q3q3 - q4q4) + _2bz * (q2q4 - q1q3) - mx)
				+ (_2bx * q2 + _2bz * q4)
				* (_2bx * (q2q3 - q1q4) + _2bz * (q1q2 + q3q4) - my)
				+ (_2bx * q1 - _4bz * q3)
				* (_2bx * (q1q3 + q2q4) + _2bz * (0.5d - q2q2 - q3q3) - mz);
		s4 = _2q2 * (2d * q2q4 - _2q1q3 - ax) + _2q3
				* (2d * q1q2 + _2q3q4 - ay) + (-_4bx * q4 + _2bz * q2)
				* (_2bx * (0.5d - q3q3 - q4q4) + _2bz * (q2q4 - q1q3) - mx)
				+ (-_2bx * q1 + _2bz * q3)
				* (_2bx * (q2q3 - q1q4) + _2bz * (q1q2 + q3q4) - my) + _2bx
				* q2
				* (_2bx * (q1q3 + q2q4) + _2bz * (0.5d - q2q2 - q3q3) - mz);
		norm = 1d / (double) Math.sqrt(s1 * s1 + s2 * s2 + s3 * s3 + s4 * s4); // normalise
																				// step
																				// magnitude
		s1 *= norm;
		s2 *= norm;
		...
		qDot1 = 0.5d * (-q2 * gx - q3 * gy - q4 * gz) - beta * s1;
		qDot2 = 0.5d * (q1 * gx + q3 * gz - q4 * gy) - beta * s2;
		qDot3 = 0.5d * (q1 * gy - q2 * gz + q4 * gx) - beta * s3;
		qDot4 = 0.5d * (q1 * gz + q2 * gy - q3 * gx) - beta * s4;
		...
		norm = 1d / (double) Math.sqrt(q1 * q1 + q2 * q2 + q3 * q3 + q4 * q4); // normalise
																				// quaternion
	...
	public void update(double gx, double gy, double gz, double ax, double ay,
		...
		s2 = _4q2 * q4q4 - _2q4 * ax + 4d * q1q1 * q2 - _2q1 * ay - _4q2 + _8q2
				* q2q2 + _8q2 * q3q3 + _4q2 * az;
		s3 = 4d * q1q1 * q3 + _2q1 * ax + _4q3 * q4q4 - _2q4 * ay - _4q3 + _8q3
				* q2q2 + _8q3 * q3q3 + _4q3 * az;
		s4 = 4d * q2q2 * q4 - _2q2 * ax + 4d * q3q3 * q4 - _2q3 * ay;
		norm = 1d / (double) Math.sqrt(s1 * s1 + s2 * s2 + s3 * s3 + s4 * s4); // normalise
																				// step
																				// magnitude
		s1 *= norm;
