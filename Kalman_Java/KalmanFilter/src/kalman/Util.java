...
import dcm.UtilMatrix;
import jeigen.DenseMatrix;
import static jeigen.Shortcuts.*;

import kalman.beans.Accelerometer;
import kalman.beans.Coordinate;
import kalman.beans.CoordinateUTM;
import kalman.beans.Gyroscope;
import kalman.beans.Magnetometer;

public class Util {
	static final double g = 9.81d; //gravedade
	
	// Calculos
	// Para conversiones de posiciones geográficas
	public static Coordinate convertMeterToGraus(Coordinate coordinate) {
		// Convertir a UTM
		CoordinateUTM utm = Util.convertDegToUTM(coordinate);

		// Calcula el gano en direción al eje X
